...
class TestRaftFunctionality(unittest.TestCase):
    ...
    def test_frontend_init(self):
        ...
        frontend_servicer.log_msg("[raft-tests.py] Started Fronted")
        frontend_server.wait_for_termination()

    def test_frontend_startraft(self):
        channel = grpc.insecure_channel("localhost:8001")
...
if __name__ == '__main__':
    ...
    suite.addTest(TestRaftFunctionality('test_frontend_init'))
    suite.addTest(TestRaftFunctionality('test_frontend_startraft'))
    suite.addTest(TestRaftFunctionality('test_frontend_put_get'))
    suite.addTest(TestRaftFunctionality('test_frontend_replace'))
